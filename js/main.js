...
document.addEventListener('DOMContentLoaded', function() {
    var iframeCover = document.querySelector('.instagram-cover');

    iframeCover.addEventListener('touchstart', function() {
        iframeCover.style.pointerEvents = 'none';
    });

    iframeCover.addEventListener('touchend', function() {
        setTimeout(function() {
            iframeCover.style.pointerEvents = 'auto';
        }, 300);
    });
});
